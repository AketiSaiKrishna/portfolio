        ...
        <div className="Footer-container">
          ...
          <div className="right">
            ...
            <div className="Social">
              <Link to="https://github.com/AketiSaiKrishna" target="_blank"><FaGithub size={30} style={{ color: 'white', marginRight: "1rem" }} /></Link>
              <Link to="https://www.linkedin.com/in/aketisaikrishna/" target="_blank"><FaLinkedin size={30} style={{ color: 'white', marginRight: "1rem" }} /></Link>
              <Link to="https://codepen.io/aketisaikrishna" target="_blank"><FaCodepen size={30} style={{ color: 'white', marginRight: "1rem" }} /></Link>
            </div>
          </div>
        </div>
      </div>
